...
struct Vector2D
{
  ...
  inline void      SetMagnitude(double length);
  ...
  inline double get_angle_in_radians() const;
...
//--------------------Get Angle (radians) --------------------------------
//------------------------------------------------------------------------
inline double Vector2D::get_angle_in_radians() const {
  return atan2(y,x);
}
...
inline Vector2D get_normal_point(Vector2D point, Vector2D line_segment_a, Vector2D line_segment_b) {

  // Vector from a to p
  Vector2D ap = point - line_segment_a;

  // Vector from a to b
  Vector2D ab = line_segment_b - line_segment_a;
...
/*------------------------------------------------*/
/* functions from PROCESSING - for Nature of Code */
/*------------------------------------------------*/
inline void Vector2D::SetMagnitude(double length) {
  this->Normalize();
  *this *= length;
}
#endif
